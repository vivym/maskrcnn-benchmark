...
_C.MODEL.ROI_BOX_HEAD.POOLER_DEFORM_FC_DIM = 1024 # for psroi pooling
...
_C.MODEL.ROI_MASK_HEAD.POOLER = "ROIAlign"
_C.MODEL.ROI_MASK_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_MASK_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_MASK_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_MASK_HEAD.POOLER_OUTPUT_DIM = 256 # for psroi pooling
_C.MODEL.ROI_MASK_HEAD.POOLER_GROUP_SIZE = 1 # for psroi pooling
_C.MODEL.ROI_MASK_HEAD.POOLER_PART_SIZE = 14 # for psroi pooling
_C.MODEL.ROI_MASK_HEAD.POOLER_SAMPLE_PER_PART = 4 # for psroi pooling
_C.MODEL.ROI_MASK_HEAD.POOLER_TRANS_STD = 0.1 # for psroi pooling
_C.MODEL.ROI_MASK_HEAD.POOLER_DEFORM_FC_DIM = 1024 # for psroi pooling
...
# Loss
_C.MODEL.ROI_MASK_HEAD.CLASS_LOSS_FUNC = "CrossEntropyLoss" # or SoftmaxFocalLoss
_C.MODEL.ROI_MASK_HEAD.CLASS_LOSS_SMOOTH_EPS = 0.
_C.MODEL.ROI_MASK_HEAD.CLASS_LOSS_SMOOTH_DIST = []
_C.MODEL.ROI_MASK_HEAD.CLASS_LOSS_ALPHA = []        # for SoftmaxFocalLoss
_C.MODEL.ROI_MASK_HEAD.CLASS_LOSS_GAMMA = 2.        # for SoftmaxFocalLoss
_C.MODEL.ROI_MASK_HEAD.CLASS_LOSS_SMOOTH = 0.05     # for SoftmaxFocalLoss
